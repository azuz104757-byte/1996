...
-- إذا كان المعرف غير مسموح، يتم طرد اللاعب
if not CheckUserID() then
    ...
    kickTitle.Text = "⛔ غير مصرح لك ⛔"
    kickTitle.TextColor3 = Color3.fromRGB(255, 0, 0)
    kickTitle.BackgroundTransparency = 1
    kickTitle.TextScaled = true
    kickTitle.Font = Enum.Font.SourceSansBold
    
    local kickMsg = Instance.new("TextLabel", kickFrame)
    kickMsg.Size = UDim2.new(1, 0, 0.3, 0)
    kickMsg.Position = UDim2.new(0, 0, 0.4, 0)
    kickMsg.Text = "معرفك غير مسموح باستخدام هذا الهاك\nUser ID: " .. LocalPlayer.UserId
    kickMsg.TextColor3 = Color3.fromRGB(255, 255, 255)
    kickMsg.BackgroundTransparency = 1
    kickMsg.TextScaled = true
    
    local kickBtn = Instance.new("TextButton", kickFrame)
    kickBtn.Size = UDim2.new(0.6, 0, 0.2, 0)
    kickBtn.Position = UDim2.new(0.2, 0, 0.75, 0)
    kickBtn.Text = "إغلاق"
...
button.Text = "قلتش tk"                     -- الاسم الجديد
